...
class DeviceIconWidgetProvider : AppWidgetProvider() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action == ACTION_ICON_WIDGET_WAKE) {
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                try {
                    ...
                    wakeLock = powerManager?.newWakeLock(
                        ...
                        "MaiWoL:IconWidgetDirectWakeLock"
                    )?.apply {
                        acquire(4000)
                    }
    ...
    companion object {
        const val ACTION_ICON_WIDGET_WAKE = "com.mai.wol.ACTION_ICON_WIDGET_WAKE"
        ...
        fun updateAppWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
            ...
            val views = RemoteViews(context.packageName, R.layout.widget_device_icon)

            if (deviceId == -1L) {
                views.setTextViewText(R.id.widget_icon_name, context.getString(R.string.app_name))

                val configIntent = Intent(context, DeviceWidgetConfigureActivity::class.java).apply {
                ...
                views.setOnClickPendingIntent(R.id.widget_icon_root, configPending)
            ...
            CoroutineScope(Dispatchers.IO).launch {
                ...
                if (device != null) {
                    views.setTextViewText(R.id.widget_icon_name, device.name)

                    val wakeIntent = Intent(context, DeviceIconWidgetProvider::class.java).apply {
                        action = ACTION_ICON_WIDGET_WAKE
                    ...
                    views.setOnClickPendingIntent(R.id.widget_icon_root, wakePendingIntent)
                } else {
                    views.setTextViewText(R.id.widget_icon_name, context.getString(R.string.widget_device_not_found))
                }
        ...
        fun updateAllWidgets(context: Context) {
            ...
            val ids = appWidgetManager.getAppWidgetIds(
                ComponentName(context, DeviceIconWidgetProvider::class.java)
            )
            for (id in ids) {
